...
[![License](https://img.shields.io/badge/License-MIT-brightgreen.svg)](https://geeknonerd.mit-license.org/2017)
...
```tmux
set -g @plugin 'geeknonerd/tmux-power'
```

### 🎨 Themes

**Gold**(default): `set -g @tmux_power_theme 'gold'`
![screenshot](https://raw.githubusercontent.com/geeknonerd/i/master/tmux-power-gold.png)

**Redwine**: `set -g @tmux_power_theme 'redwine'`
![screenshot](https://raw.githubusercontent.com/geeknonerd/i/master/tmux-power-redwine.png)

**Moon**: `set -g @tmux_power_theme 'moon'`
![screenshot](https://raw.githubusercontent.com/geeknonerd/i/master/tmux-power-moon.png)

**Forest**: `set -g @tmux_power_theme 'forest'`
![screenshot](https://raw.githubusercontent.com/geeknonerd/i/master/tmux-power-forest.png)

**Violet**: `set -g @tmux_power_theme 'violet'`
![screenshot](https://raw.githubusercontent.com/geeknonerd/i/master/tmux-power-violet.png)

**Snow**: `set -g @tmux_power_theme 'snow'`
![screenshot](https://raw.githubusercontent.com/geeknonerd/i/master/tmux-power-snow.png)

**Coral**: `set -g @tmux_power_theme 'coral'`
![screenshot](https://raw.githubusercontent.com/geeknonerd/i/master/tmux-power-coral.png)

**Sky**: `set -g @tmux_power_theme 'sky'`
![screenshot](https://raw.githubusercontent.com/geeknonerd/i/master/tmux-power-sky.png)
...
[MIT](https://geeknonerd.mit-license.org/2017) (c) Levi
